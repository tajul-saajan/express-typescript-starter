...
describe('Testing Users', () => {
  describe('[GET] /users', () => {
    it('response findAll users', async () => {
      ...
      const userService = usersRoute.usersController.userService;

      userService.findAllUser = jest.fn().mockReturnValue([
        {
          id: 1,
          email: 'a@email.com',
  ...
  describe('[GET] /users/:id', () => {
    it('response findOne user', async () => {
      ...
      userService.findUserById = jest.fn().mockReturnValue({
        id: 1,
        email: 'a@email.com',
        password: await bcrypt.hash('q1w2e3r4!', 10),
      });
  ...
  describe('[POST] /users', () => {
    it('response Create user', async () => {
      ...
      userService.findUserById = jest.fn().mockReturnValue(null);
